...
export const metadata: Metadata = {
  title: 'Contacto',
  description: 'Contactate con Cooperación: escribinos y te respondemos a la brevedad.',
};

export default async function CooperacionContactoPage() {
        ...
        <div className="container">
          <div className="row g-5">
            <div className="col-lg-5 wow animate__animated animate__fadeInUp">
              ...
              <hr className="text-color-1 my-4" />
              ...
              <div className="d-flex gap-3">
                {section?.facebook && (
                  <a
                    ...
                    className="rounded-circle d-flex align-items-center justify-content-center icon-80 border border-color-1 bg-color-6 text-color-1"
                    aria-label="Facebook"
                  >
