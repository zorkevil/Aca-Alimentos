...
export const metadata: Metadata = {
  ...
  description: 'Respuestas a las consultas más frecuentes sobre los productos Petlink.',
};
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Te recomendamos hacer la transición de forma gradual, mezclando el alimento anterior con Petlink durante 7 a 10 días, aumentando progresivamente la proporción del nuevo alimento hasta reemplazarlo por completo.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Petlink es fabricado por ACA Alimentos S.A. en Argentina, bajo estrictos controles de calidad en cada etapa del proceso productivo.',
  },
  {
    question: '¿Puedo vender Petlink en mi veterinaria o petshop?',
    answer: 'Sí, podés convertirte en punto de venta de Petlink. Escribinos a través del formulario de contacto y nuestro equipo comercial se pondrá en contacto con vos.',
  },
];

export default function PetlinkFaqsPage() {
  return (
    <>
