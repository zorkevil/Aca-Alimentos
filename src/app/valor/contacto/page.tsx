...
export const metadata: Metadata = {
  title: 'Contacto',
  description: 'Contactate con Valor: escribinos y te respondemos a la brevedad.',
};

export default async function ValorContactoPage() {
              ...
              <div className="d-flex gap-3">
                {section?.facebook && (
                  <a
                    ...
                    className="rounded-circle d-flex align-items-center justify-content-center icon-80 text-color-1"
                    aria-label="Facebook"
                  >
